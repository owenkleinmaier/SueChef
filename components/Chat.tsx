      ...
      >
        {messages.length === 0 && (
          <div className="flex items-start gap-3 mb-6">
            ...
            <div className="border-2 border-[#193554] rounded-2xl relative bg-[#FFFCF4] p-5 text-base font-medium text-[#193554] leading-relaxed max-w-[80%]">
              ...
              list. Feeling adventurous? I'll find something new to try. In the
              mood for comfort food? I've got just the thing. From knife skills
              to oven timing, I'm here to take the stress out of cooking. Want
              to keep things healthy? I'll adjust recipes based on your goals.
              You can pause me, skip steps, or ask for visual guides anytime.
              I'll remember what you like, what you avoid, and what you've
              already tried. Let's turn your kitchen into your happy place. Just
              say the word and we'll get cooking. I can also play music, track
              your pantry items, or adjust portion sizes. Don't worry if you're
              not a pro — we'll take it one step at a time. Ready when you are.
